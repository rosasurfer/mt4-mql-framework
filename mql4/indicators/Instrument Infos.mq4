...
int UpdateInstrumentInfos() {
   ...
   ObjectSetText(labels[I_TOTAL_COST_DATA        ],                      ifString(!totalCostP,  "-", NumberToStr(totalCostPunit, pUnitFormat) + _spUnit) +" = "+ NumberToStr(NormalizeDouble(totalCostPct, 3), ".1+") +"%/TxV", fontSize, fontName, fontColor);
