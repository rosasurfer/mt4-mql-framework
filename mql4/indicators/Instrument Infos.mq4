...
int UpdateInstrumentInfos() {
   ...
   ObjectSetText(labels[I_ADR                    ], "ADR(20):  "       + ifString(!adr,   "n/a", DoubleToStr(adr/pUnit, pDigits) + _spUnit +" = "+ NumberToStr(NormalizeDouble(volaPerADR, 2), ".0+") +"%"),                                           fontSize, fontName, fontColor);
   ...
   ObjectSetText(labels[I_COMMISSION_DATA        ],                      ifString(!commission, "-", DoubleToStr(commission, 2) +" "+ accountCurrency +" = "+ NumberToStr(NormalizeDouble(commissionP/pUnit, pDigits+1), "."+ pDigits +"+") + _spUnit), fontSize, fontName, fontColor);
   ObjectSetText(labels[I_TOTAL_COST_DATA        ],                      ifString(!commission, "-", NumberToStr(NormalizeDouble((spreadP + commissionP)/pUnit, pDigits+1), "."+ pDigits +"+") + _spUnit),                                              fontSize, fontName, fontColor);
