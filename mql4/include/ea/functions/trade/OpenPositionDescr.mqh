...
string OpenPositionDescr() {
   ...
   sValues[17] = "runupP="      +   ifString(!open.runupP,       "0", NumberToStr(open.runupP,       ".1+"));
   sValues[18] = "drawdownP="   +   ifString(!open.drawdownP,    "0", NumberToStr(open.drawdownP,    ".1+"));
   sValues[19] = "sigProfitP="  +   ifString(!open.sigProfitP,   "0", NumberToStr(open.sigProfitP,   ".1+"));
   sValues[20] = "sigRunupP="   +   ifString(!open.sigRunupP,    "0", NumberToStr(open.sigRunupP,    ".1+"));
   sValues[21] = "sigDrawdownP="+   ifString(!open.sigDrawdownP, "0", NumberToStr(open.sigDrawdownP, ".1+"));
