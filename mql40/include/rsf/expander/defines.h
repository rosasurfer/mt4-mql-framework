...
#define MODE_SYSTEM                             2        // don't restrict file system operations
#define MODE_TESTER                             4        // with MODE_MQL: apply the tester sandbox
#define MODE_MKPARENT                           8        // create non-existing parent directories as needed, @see CreateDirectory()
...
#define ID_CHART_TEMPLATE_DEFAULT           34825        //          Templates->Default
#define ID_CHART_TEMPLATE_OFFLINE           34826        //          Templates->Offline
#define ID_CHART_TEMPLATE_TESTER            34827        //          Templates->Tester
#define ID_CHART_TEMPLATE_USER1             34800        //          Templates->{first-user-template}
