 ...
 *     FATAL  US500,M202  Superbars ::start(6)  Bar[last.startBarOpenTime]=2022.06.02 21:35:23 not found [ERR_RUNTIME_ERROR]
 *     FATAL  US500,M202  Grid      ::start(6)  Bar[last.startBarOpenTime]=2022.06.02 21:35:23 not found [ERR_RUNTIME_ERROR]
 *     FATAL  US500,M202  ChartInfos::start(6)  Bar[last.startBarOpenTime]=2022.06.02 21:35:23 not found [ERR_RUNTIME_ERROR]
 *
 *  - NOTICE  BTCUSD,202  ChartInfos::rsfLib::AquireLock(6)  couldn't get lock for mutex "mutex.ChartInfos.command" after 1.092 sec., retrying...
 *    NOTICE  BTCUSD,202  ChartInfos::rsfLib::AquireLock(6)  couldn't get lock for mutex "mutex.ChartInfos.command" after 2.075 sec., retrying...
 *    NOTICE  BTCUSD,202  ChartInfos::rsfLib::AquireLock(6)  couldn't get lock for mutex "mutex.ChartInfos.command" after 3.058 sec., retrying...
 *    NOTICE  BTCUSD,202  ChartInfos::rsfLib::AquireLock(6)  couldn't get lock for mutex "mutex.ChartInfos.command" after 4.041 sec., retrying...
 *    NOTICE  BTCUSD,202  ChartInfos::rsfLib::AquireLock(6)  couldn't get lock for mutex "mutex.ChartInfos.command" after 5.024 sec., retrying...
 *    NOTICE  BTCUSD,202  ChartInfos::rsfLib::AquireLock(6)  couldn't get lock for mutex "mutex.ChartInfos.command" after 6.006 sec., retrying...
 *    NOTICE  BTCUSD,202  ChartInfos::rsfLib::AquireLock(6)  couldn't get lock for mutex "mutex.ChartInfos.command" after 7.098 sec., retrying...
 *    NOTICE  BTCUSD,202  ChartInfos::rsfLib::AquireLock(6)  couldn't get lock for mutex "mutex.ChartInfos.command" after 8.081 sec., retrying...
 *    NOTICE  BTCUSD,202  ChartInfos::rsfLib::AquireLock(6)  couldn't get lock for mutex "mutex.ChartInfos.command" after 9.064 sec., retrying...
 *    FATAL   BTCUSD,202  ChartInfos::rsfLib::AquireLock(5)  failed to get lock for mutex "mutex.ChartInfos.command" after 10.047 sec., giving up  [ERR_RUNTIME_ERROR]
 *
 *  - on account change:
