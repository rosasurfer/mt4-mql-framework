...
#define ERS_HISTORY_UPDATE                                         4066    // history is updated (non-terminating status)
...
#define ERS_EXECUTION_STOPPING                                    65539    // IsStopped() returned TRUE (non-terminating status)
