...
int UpdateInstrumentInfos() {
   ...
   ObjectSetText(labels[I_TOTAL_COST_DATA        ],                      ifString(!totalCostP,  "-", NumberToStr(totalCostPunit, pUnitFormat) + _spUnit) +" = "+ NumberToStr(NormalizeDouble(totalCostPct, 4), ".1+") +"%/TrxV", fontSize, fontName, fontColor);
