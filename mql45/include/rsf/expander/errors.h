/**
 * MQL error codes shared with the MT4Expander DLL.
 *
 * @link  https://docs.mql4.com/constants/errorswarnings/errorcodes
 */
#define ERR_NO_ERROR                                                  0
#define NO_ERROR                                           ERR_NO_ERROR    // in C++ already defined (Win32)
...
#define ERR_ARRAY_INDEX_OUT_OF_RANGE                               4002    // MQL4.5: without "#property strict" this error is ignored and never set
...
#define ERS_HISTORY_UPDATE                                         4066    // history is updated (non-terminating error)
...
#define ERS_EXECUTION_STOPPING                                    65539    // IsStopped() returned TRUE (non-terminating error)
...
#define ERR_INVALID_VALUE                                         65544    // invalid value
#define ERR_INVALID_COMMAND                                       65545    // invalid or unknown command
#define ERR_INVALID_CONFIG_VALUE                                  65546    // invalid configuration parameter
#define ERR_INVALID_FILE_FORMAT                                   65547    // invalid file format
#define ERR_INVALID_INPUT_PARAMETER                               65548    // invalid input parameter
...
#define ERS_TERMINAL_NOT_YET_READY                                65556    // terminal not yet ready (in scripts a terminating, otherwise a non-terminating error)
