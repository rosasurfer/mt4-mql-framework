...
int UpdateInstrumentInfos() {
   ...
   double commissionP     = NormalizeDouble(MathDiv(commission, fullPointValue), Digits+1);     // + 1 digit for sub-precision
   ...
   ObjectSetText(labels[I_COMMISSION_DATA        ],                      ifString(!commission, "-", DoubleToStr(commission, 2) +" "+ accountCurrency +"/lot = "+ NumberToStr(commissionP/pUnit, "."+ pDigits +"+") + _spUnit), fontSize, fontName, fontColor);
