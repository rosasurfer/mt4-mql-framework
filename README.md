...
Due to a DMCA notice from MetaQuotes I had to disable the terminal downloads. So att the moment MetaTrader 4 can only be downloaded from
your broker's website. I'm working on a solution to fix this.
