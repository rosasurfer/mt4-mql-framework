...
string   lo.Comment             (/*LFX_ORDER*/int lo[]         ) {                        return(GetStringA(GetIntsAddress(lo) + I_LFX_ORDER.comment*4));                                                                             LFX_ORDER.toStr(lo); }
...
string   los.Comment            (/*LFX_ORDER*/int lo[][], int i) {                        return(GetStringA(GetIntsAddress(lo)+ (i*LFX_ORDER.intSize + I_LFX_ORDER.comment)*4));                                                      LFX_ORDER.toStr(lo); }
