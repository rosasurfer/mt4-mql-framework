...
extern string Close.Tickets      = "";    // tickets separated by comma (w/wo leeding "#") or a logmessage as generated by AnalyzePositions(F_DUMP_TICKETS)
...
int onInit() {
   ...
   if (StrContains(sValue, "{") && StrEndsWith(sValue, "}")) {    // extract the ticket substring from an AnalyzePositions(F_DUMP_TICKETS) message: "log-message {#ticket1, ..., #ticketN}"
