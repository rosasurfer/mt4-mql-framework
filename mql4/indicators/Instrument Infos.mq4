...
int UpdateInstrumentInfos() {
   ...
   string serverName      = GetAccountServerName(); ObjectSetText(labels[I_SERVER_NAME    ], "Server:               "+ serverName, fgFontSize, fgFontName, ifInt(!StringLen(serverName), fgFontColorDisabled, fgFontColor));
