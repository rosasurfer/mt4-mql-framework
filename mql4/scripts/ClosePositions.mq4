/**
 * Close all tickets matching the specified inputs. Without any input all open tickets are closed.
 */
...
extern string Close.Tickets      = "";    // tickets separated by comma (w/o leeding "#") or a logmessage as generated by CustomPositions.LogTickets()
...
int onInit() {
   ...
   if (StrContains(sValue, "{") && StrEndsWith(sValue, "}")) {    // extract the ticket substring from a CustomPositions.LogTickets() message: "log-message {#ticket1, ..., #ticketN}"
