...
datetime ec_CurrentTickTime    (int ec[]);;
...
datetime ec_PreviousTickTime   (int ec[]);;
...
int      ec_TestDuration       (int ec[]);;
datetime ec_TestEndTime        (int ec[]);;
int      ec_TestId             (int ec[]);;
bool     ec_Testing            (int ec[]);;
int      ec_TestReportingId    (int ec[]);;
string   ec_TestReportingSymbol(int ec[]);;
...
datetime mec_CurrentTickTime   (int ec[]);;
...
datetime mec_PreviousTickTime  (int ec[]);;
int      mec_ProgramIndex      (int ec[]);;
