/**
 * Drop-in replacement for the flawed built-in function StringSubstr(). Fixes StringSubstr(string, start, length = 0) which
 * returns the whole remainder of the string instead of an empty string. Additionally this implementation supports negative
 * values for parameters "start" and "length".
 *
