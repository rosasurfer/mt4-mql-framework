...
bool SaveStatus.TradeStats(string file, bool fileExists) {
   ...
   WriteIniString(file, section, "trades.avgRunup",     /*double  */ DoubleToStr(stats[METRIC_NET_UNITS][S_TRADES_AVG_RUNUP   ] * pMultiplier, pDigits));
   WriteIniString(file, section, "trades.avgDrawdown",  /*double  */ DoubleToStr(stats[METRIC_NET_UNITS][S_TRADES_AVG_DRAWDOWN] * pMultiplier, pDigits));
   WriteIniString(file, section, "trades.avgProfit",    /*double  */ DoubleToStr(stats[METRIC_NET_UNITS][S_TRADES_AVG_PROFIT  ] * pMultiplier, pDigits) + separator);
   ...
   WriteIniString(file, section, "winners.avgRunup",    /*double  */ DoubleToStr(stats[METRIC_NET_UNITS][S_WINNERS_AVG_RUNUP   ] * pMultiplier, pDigits));
   WriteIniString(file, section, "winners.avgDrawdown", /*double  */ DoubleToStr(stats[METRIC_NET_UNITS][S_WINNERS_AVG_DRAWDOWN] * pMultiplier, pDigits));
   WriteIniString(file, section, "winners.avgProfit",   /*double  */ DoubleToStr(stats[METRIC_NET_UNITS][S_WINNERS_AVG_PROFIT  ] * pMultiplier, pDigits) + separator);
   ...
   WriteIniString(file, section, "losers.avgRunup",     /*double  */ DoubleToStr(stats[METRIC_NET_UNITS][S_LOSERS_AVG_RUNUP   ] * pMultiplier, pDigits));
   WriteIniString(file, section, "losers.avgDrawdown",  /*double  */ DoubleToStr(stats[METRIC_NET_UNITS][S_LOSERS_AVG_DRAWDOWN] * pMultiplier, pDigits));
   WriteIniString(file, section, "losers.avgProfit",    /*double  */ DoubleToStr(stats[METRIC_NET_UNITS][S_LOSERS_AVG_PROFIT  ] * pMultiplier, pDigits) + separator);

   WriteIniString(file, section, "scratch",             /*double  */ StrPadRight(Round(stats[METRIC_NET_UNITS][S_SCRATCH]),       23) + StrPadLeft("("+ DoubleToStr(100 * stats[METRIC_NET_UNITS][S_SCRATCH_PCT      ], 1) +"%)", 8));
   ...
   WriteIniString(file, section, "trades.avgRunup",     /*double  */ DoubleToStr(stats[METRIC_SIG_UNITS][S_TRADES_AVG_RUNUP   ] * pMultiplier, pDigits));
   WriteIniString(file, section, "trades.avgDrawdown",  /*double  */ DoubleToStr(stats[METRIC_SIG_UNITS][S_TRADES_AVG_DRAWDOWN] * pMultiplier, pDigits));
   WriteIniString(file, section, "trades.avgProfit",    /*double  */ DoubleToStr(stats[METRIC_SIG_UNITS][S_TRADES_AVG_PROFIT  ] * pMultiplier, pDigits) + separator);
   ...
   WriteIniString(file, section, "winners.avgRunup",    /*double  */ DoubleToStr(stats[METRIC_SIG_UNITS][S_WINNERS_AVG_RUNUP   ] * pMultiplier, pDigits));
   WriteIniString(file, section, "winners.avgDrawdown", /*double  */ DoubleToStr(stats[METRIC_SIG_UNITS][S_WINNERS_AVG_DRAWDOWN] * pMultiplier, pDigits));
   WriteIniString(file, section, "winners.avgProfit",   /*double  */ DoubleToStr(stats[METRIC_SIG_UNITS][S_WINNERS_AVG_PROFIT  ] * pMultiplier, pDigits) + separator);
   ...
   WriteIniString(file, section, "losers.avgRunup",     /*double  */ DoubleToStr(stats[METRIC_SIG_UNITS][S_LOSERS_AVG_RUNUP   ] * pMultiplier, pDigits));
   WriteIniString(file, section, "losers.avgDrawdown",  /*double  */ DoubleToStr(stats[METRIC_SIG_UNITS][S_LOSERS_AVG_DRAWDOWN] * pMultiplier, pDigits));
   WriteIniString(file, section, "losers.avgProfit",    /*double  */ DoubleToStr(stats[METRIC_SIG_UNITS][S_LOSERS_AVG_PROFIT  ] * pMultiplier, pDigits) + separator);

   WriteIniString(file, section, "scratch",             /*double  */ StrPadRight(Round(stats[METRIC_SIG_UNITS][S_SCRATCH]),       23) + StrPadLeft("("+ DoubleToStr(100 * stats[METRIC_SIG_UNITS][S_SCRATCH_PCT      ], 1) +"%)", 8));
