...
#define MODE_ALL_UPPER_CROSS       8                           //  8: all upper channel crossings
#define MODE_ALL_LOWER_CROSS       9                           //  9: all lower channel crossings
#define MODE_UPPER_CROSS_EXIT      10                          // 10: exit points of upper channel crossings
