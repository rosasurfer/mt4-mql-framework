...
int      iChangedBars(string symbol=NULL, int timeframe=NULL, int flags=NULL);;
int      iCopyRates(double target[][6], string symbol=NULL, int timeframe=NULL, int flags=NULL);;
