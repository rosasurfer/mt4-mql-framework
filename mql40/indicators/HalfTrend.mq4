...
int onInit() {
   ...
   if (Signal.onTrendChange) {
      ...
      if (Signal.onTrendChange.Sound || Signal.onTrendChange.Alert || Signal.onTrendChange.Mail) {
...
bool onTrendChange(int trend) {
   ...
   if (trend == MODE_UPTREND) {
      message = indicatorName +" turned up (bid: "+ NumberToStr(_Bid, PriceFormat) +")";
   ...
   if (trend == MODE_DOWNTREND) {
      message = indicatorName +" turned down (bid: "+ NumberToStr(_Bid, PriceFormat) +")";
