 ...
 *
 *
 * Purpose of the trailing double semicolon: Normally, you only want function definitions to appear in the "Function List"
 * browser of UEStudio. You don't want function imports (which end with a single semicolon) to appear. A trailing double
 * semicolon after a declaration/import allows to bypass this rule in UEStudio to create a function listing of this file.
 *
 * @see  RegEx definition in UEStudio syntax file for MQL
 */
...
int      oes.Error             (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
bool     oes.IsError           (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
string   oes.Symbol            (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
int      oes.Digits            (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
double   oes.StopDistance      (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
double   oes.FreezeDistance    (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
double   oes.Bid               (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
double   oes.Ask               (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
int      oes.Ticket            (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
int      oes.Type              (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
double   oes.Lots              (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
datetime oes.OpenTime          (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
double   oes.OpenPrice         (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
double   oes.StopLoss          (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
double   oes.TakeProfit        (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
datetime oes.CloseTime         (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
double   oes.ClosePrice        (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
double   oes.Swap              (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
double   oes.Commission        (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
double   oes.Profit            (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
string   oes.Comment           (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
int      oes.Duration          (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
int      oes.Requotes          (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
double   oes.Slippage          (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
int      oes.RemainingTicket   (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
double   oes.RemainingLots     (/*ORDER_EXECUTION*/int oe[][], int i = 0);;
...
int      HistoryFile1.Open     (string symbol, int timeframe, string descr, int digits, int format, int mode, string directory = "");;
...
int      HistoryFile2.Open     (string symbol, int timeframe, string descr, int digits, int format, int mode, string directory = "");;
...
int      HistoryFile3.Open     (string symbol, int timeframe, string descr, int digits, int format, int mode, string directory = "");;
...
int      AddSymbolGroup(int sgs[], string name, string descr, color bgColor);;
...
int      CreateRawSymbol(string name, string descr, string group, int digits, string baseCurrency, string marginCurrency, string hstDirectory = "");;
...
int      CreateDirectoryW(string path, int flags);;
...
bool     IsDirectoryW(string path, int mode);;
bool     IsFileA(string path, int mode);;
bool     IsFileOrDirectoryA(string path);;
bool     IsFileOrDirectoryW(string path);;
