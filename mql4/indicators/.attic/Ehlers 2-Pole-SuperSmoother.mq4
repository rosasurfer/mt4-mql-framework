 ...
 *
 * As described in his book "Cybernetic Analysis for Stocks and Futures". Obsolet as the visual representation is almost the
 * same as the ALMA (with a little more lag than the ALMA).
 *
 *
