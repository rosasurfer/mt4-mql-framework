...
bool SaveStatus.TradeStats(string file, bool fileExists) {
   ...
   WriteIniString(file, section, "maxDrawdown",        /*double  */ DoubleToStr(instance.maxNetDrawdownP /pUnit, pDigits) + separator);
   ...
   WriteIniString(file, section, "losers.avgProfit",   /*double  */ DoubleToStr(stats[METRIC_NET_UNITS][S_LOSERS_AVG_PROFIT  ]/pUnit, pDigits));
   ...
   WriteIniString(file, section, "maxDrawdown",        /*double  */ DoubleToStr(instance.maxSigDrawdownP /pUnit, pDigits) + separator);
   ...
   WriteIniString(file, section, "losers.avgProfit",   /*double  */ DoubleToStr(stats[METRIC_SIG_UNITS][S_LOSERS_AVG_PROFIT  ]/pUnit, pDigits));
