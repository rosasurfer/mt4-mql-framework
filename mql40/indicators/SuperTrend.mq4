 ...
 * @see   /mql40/indicators/HalfTrend.mq4
 *
...
bool onTrendChange(int direction) {
   ...
   string eventName = "rsf::"+ StdSymbol() +","+ sPeriod +"."+ WindowExpertName() +"("+ ATR.Periods +").onTrendChange("+ direction +")."+ TimeToStr(Time[0]), propertyName = "";
