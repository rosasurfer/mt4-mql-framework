...
int onTick() {
   ...
   if (tmaStartbar < 0)        return(!logInfo("onTick(2)  Tick="+ Ticks +"  Bars="+ Bars +"  needed=?", SetLastError(ERR_HISTORY_INSUFFICIENT)));
   ...
   if (channelStartbarNRP < 0) return(!logInfo("onTick(3)  Tick="+ Ticks +"  Bars="+ Bars +"  needed=?", SetLastError(ERR_HISTORY_INSUFFICIENT)));
