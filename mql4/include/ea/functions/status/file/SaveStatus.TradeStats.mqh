...
bool SaveStatus.TradeStats(string file, bool fileExists) {
   ...
   WriteIniString(file, section, "trades.avgDrawdown",  /*double  */ DoubleToStr(stats[METRIC_NET_UNITS][S_TRADES_AVG_DRAWDOWN]/pUnit, pDigits));
   WriteIniString(file, section, "trades.avgProfit",    /*double  */ DoubleToStr(stats[METRIC_NET_UNITS][S_TRADES_AVG_PROFIT  ]/pUnit, pDigits) + separator);
   ...
   WriteIniString(file, section, "winners.avgDrawdown", /*double  */ DoubleToStr(stats[METRIC_NET_UNITS][S_WINNERS_AVG_DRAWDOWN]/pUnit, pDigits));
   WriteIniString(file, section, "winners.avgProfit",   /*double  */ DoubleToStr(stats[METRIC_NET_UNITS][S_WINNERS_AVG_PROFIT  ]/pUnit, pDigits) + separator);
   ...
   WriteIniString(file, section, "losers.avgDrawdown",  /*double  */ DoubleToStr(stats[METRIC_NET_UNITS][S_LOSERS_AVG_DRAWDOWN]/pUnit, pDigits));
   WriteIniString(file, section, "losers.avgProfit",    /*double  */ DoubleToStr(stats[METRIC_NET_UNITS][S_LOSERS_AVG_PROFIT  ]/pUnit, pDigits) + separator);
   ...
   WriteIniString(file, section, "minProfit",           /*double  */ DoubleToStr(instance.maxSigDrawdownP /pUnit, pDigits));
   WriteIniString(file, section, "maxProfit",           /*double  */ DoubleToStr(instance.maxSigProfitP   /pUnit, pDigits) + separator);
   ...
   WriteIniString(file, section, "trades.avgDrawdown",  /*double  */ DoubleToStr(stats[METRIC_SIG_UNITS][S_TRADES_AVG_DRAWDOWN]/pUnit, pDigits));
   WriteIniString(file, section, "trades.avgProfit",    /*double  */ DoubleToStr(stats[METRIC_SIG_UNITS][S_TRADES_AVG_PROFIT  ]/pUnit, pDigits) + separator);
   ...
   WriteIniString(file, section, "winners.avgDrawdown", /*double  */ DoubleToStr(stats[METRIC_SIG_UNITS][S_WINNERS_AVG_DRAWDOWN]/pUnit, pDigits));
   WriteIniString(file, section, "winners.avgProfit",   /*double  */ DoubleToStr(stats[METRIC_SIG_UNITS][S_WINNERS_AVG_PROFIT  ]/pUnit, pDigits) + separator);
   ...
   WriteIniString(file, section, "losers.avgDrawdown",  /*double  */ DoubleToStr(stats[METRIC_SIG_UNITS][S_LOSERS_AVG_DRAWDOWN]/pUnit, pDigits));
   WriteIniString(file, section, "losers.avgProfit",    /*double  */ DoubleToStr(stats[METRIC_SIG_UNITS][S_LOSERS_AVG_PROFIT  ]/pUnit, pDigits) + separator);
