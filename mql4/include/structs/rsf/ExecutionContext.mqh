...
#import "rsfExpander.dll"
   ...
   bool     ec_LogToDebugEnabled   (/*EXECUTION_CONTEXT*/int ec[]);
   bool     ec_LogToTerminalEnabled(/*EXECUTION_CONTEXT*/int ec[]);
   bool     ec_LogToCustomEnabled  (/*EXECUTION_CONTEXT*/int ec[]);
   //       ec.customLogFile
   ...
   bool     ec_SetLogToDebugEnabled   (/*EXECUTION_CONTEXT*/int ec[], int status  );
   bool     ec_SetLogToTerminalEnabled(/*EXECUTION_CONTEXT*/int ec[], int status  );
   bool     ec_SetLogToCustomEnabled  (/*EXECUTION_CONTEXT*/int ec[], int status  );
