<!--
An improved Vegas Tunnel. The original tunnel is built from EMA(144) + EMA(169) and is way too narrow. 
Here it's replaced by a "XARD 3-MA-Tunnel" which is wider and produces better signals.
-->
