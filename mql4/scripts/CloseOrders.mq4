...
extern string Close.Tickets      = "";             // tickets separated by comma (with or w/o leading "#") or a logmessage formatted like ChartInfos::AnalyzePositions(F_LOG_TICKETS)
...
extern bool   Close.HedgedPart   = false;          // close hedged part only
